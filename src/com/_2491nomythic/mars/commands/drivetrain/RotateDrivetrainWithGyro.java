...
public class RotateDrivetrainWithGyro extends CommandBase {
	 ...
	 *            The angle for the robot to turn
	 * @param power
	 *            The power fed to all drive motors, ranging from 0 to 1
	 * @param turnLeft
	 *            Whether or not the robot rotates to the left (false rotates to the right)
	 */

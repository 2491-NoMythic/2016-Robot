...
import com._2491nomythic.mars.commands.autonomous.DriveOverMoat;
...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		autoChooser.addObject("Drive Over Moat", new DriveOverMoat());
		autoChooser.addObject("Drive Under Low Bar", new DriveUnderLowBarDistance());

...
public class AlignShooter extends CommandBase {
	...
	protected void initialize() {
		...
		requiredMovment = (400 - grip.getCenterX()[0]) * Constants.degreesPerPixel + Constants.pixelCompensationToTargetWidthRatio * grip.getWidth()[0] * Constants.degreesPerPixel;
